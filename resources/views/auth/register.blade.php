    ...
    <div class="panel panel-color panel-primary panel-pages">
        ...
        <form class="form-horizontal m-t-20"  method="POST" action="{{ route('register') }}">
            ...
            <div class="form-group ">
                <div class="col-xs-12">
                    <input class="form-control input-lg" id="name" type="text" required="" placeholder="Username" name="name" value="{{ old('name') }}" required autofocus>
                    @if ($errors->has('name'))
            ...
            <div class="form-group">
                <div class="col-xs-12">
                    <input class="form-control input-lg" type="password" required="" placeholder="Comfirm Password" name="password_confirmation" required>
