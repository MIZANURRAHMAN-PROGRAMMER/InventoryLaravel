 ...
 <div class="row">
      ...
      <div class="col-md-8 col-md-offset-2">
        <div class="panel panel-default">
            ...
            @endif
                <form role="form" action="{{ url('/update_supplier/'.$edit->id) }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="exampleInputEmail1" value="{{ $edit->shop }}" name="shopename" required>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <select name="type" id="exampleInputEmail1" class="form-control">
                   ...
                   <a href="{{ route('all.supplier') }}"> <button  class="btn btn-primary waves-effect waves-dark"><i class="fa fa-arrow-left"></i> back</button></a>
                </form>
            </div><!-- panel-body -->
        </div> <!-- panel -->
    </div> <!-- col-->
